<template>
  <header class="chi-header -portal">
    <nav class="chi-header__toolbar">
      ...
      <div class="chi-header__end">
        <a href="#">
          <i class="chi-icon icon-comments-dots-outline"></i> Chat
        </a>
        <a class="-ml--2" href="#">Contact Us</a>
        <a class="-ml--2" href="#">Español</a>
      </div>
    </nav>
    ...
    <nav class="chi-header__content">
      ...
      <div class="chi-header__start">
        ...
        <div class="-d--none -d-lg--flex my-menu">
          <a href="/" class="chi-button -flat">
            <i class="chi-icon icon-home-outline -md"></i>
            <p>Home</p>
          </a>
          <a href="/my-bill" class="chi-button -flat">
            <i class="chi-icon icon-file-invoice -md"></i>
            <p>Bill</p>
          </a>
          <a href="/my-products" class="chi-button -flat">
            <i class="chi-icon icon-home-outline -md"></i>
            <p>Products</p>
          </a>
          <a href="/my-support" class="chi-button -flat">
            <i class="chi-icon icon-life-ring -md"></i>
            <p>Support</p>
          </a>
          <a href="/my-settings" class="chi-button -flat">
            <i class="chi-icon icon-settings -md"></i>
            <p>Settings</p>
          </a>
        </div>
      </div>
      <div class="chi-header__end">
        <div class="-d--none -d-lg--flex">
          ...
          <div class="chi-dropdown -d--none -d-lg--flex">
            <button class="chi-button -flat chi-dropdown__trigger -px--1 -animate" id="button-user-menu" data-position="bottom-end">John Doe</button>
