    ...
    <nav class="chi-header__content">
      ...
      <div class="chi-header__start">
        ...
        <div class="chi-dropdown -d--none -d-lg--flex">
          <button class="chi-button -flat -light chi-dropdown__trigger -text--lg -px--1 -animate -no-hover" id="button-site-menu2">App name</button>
          <div class="chi-dropdown__menu -inverse -list -w--lg">
      ...
      <div class="chi-header__end">
        <div class="-d--none -d-lg--flex">
          <button class="chi-button -flat -light -icon -no-hover" aria-label="Notifcations">
            <div class="chi-button__content">
              <i class="chi-icon icon-bell-outline" aria-hidden="true"></i>
            </div>
          </button>
          <button class="chi-button -flat -light -icon -no-hover" aria-label="Support">
            <div class="chi-button__content">
              <i class="chi-icon icon-circle-question-outline" aria-hidden="true"></i>
            </div>
          </button>
          <div class="chi-divider -vertical -inverse"></div>
          <div class="chi-dropdown -d--none -d-lg--flex">
            <button class="chi-button -flat -light chi-dropdown__trigger -px--1 -animate -no-hover" id="button-user-menu2" data-position="bottom-end">Menu</button>
            <div class="chi-dropdown__menu -inverse -w--sm">
          ...
          <div class="chi-dropdown -d--none -d-lg--flex">
            <button class="chi-button -flat -light chi-dropdown__trigger -px--1 -animate -no-hover" id="button-eid-menu2" data-position="bottom-end">Menu</button>
            <div class="chi-dropdown__menu -inverse -w--sm">
              <a class="chi-dropdown__menu-item" href="#">
                <i class="chi-icon icon-user"></i>
                <span>Item 1</span>
